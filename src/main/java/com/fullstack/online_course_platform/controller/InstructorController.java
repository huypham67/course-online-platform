...
public class InstructorController {
    ...
    @ApiResponses({
        ...
        public ApiResult<Void> updateCurrentInstructorProfile(@Valid @RequestBody UpdateInstructorRequest request) {
                instructorService.updateCurrentProfile(request);
                return ApiResult.of(HttpStatus.OK, "Instructor profile updated successfully", null);
    }
